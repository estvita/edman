...
ADMINS = [("""Anton Gulin""", "toogulin@gmail.com")]
...
ACCOUNT_FORMS = {"signup": "edman.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "edman.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "edman.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "edman API",
    "DESCRIPTION": "Documentation of API endpoints of edman",
    "VERSION": "1.0.0",
